<template>
  <div class="pt-[120px] pb-16">
    <div class="container">
      <div data-aos="fade-up" class="aspect-video rounded-[20px] border border-[#ECECEC] w-full h-full relative overflow-hidden">

        <div class="bg-black/20 absolute inset-0 w-full h-full z-10 flex-center">
      ...
      <div data-aos="fade-up" class="my-8">
        ...
        <p class="whitespace-pre-line mt-1 text-xl leading-140">{{data?.about}}</p>
      </div>
    ...
    <BaseModal v-model="showModal" no-header has-close body-class="!bg-transparent !max-w-[1280px]">
